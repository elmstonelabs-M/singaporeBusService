...
class RetentionService:
    ...
    async def get_retention_range(
        ...
        *,
        ...
        while cursor <= end_date:
            rows.append(await self.get_retention(cursor, today=current_date))
    ...
    async def get_retention(
        ...
        *,
        ...
        cohort_key = _cohort_key(cohort_date_text)
    ...
    async def _retention_metric(
        ...
        *,
        ...
        active_key = _active_key(target_date_text)
...
def _first_seen_key(device_id: str) -> str:
    return f"{RETENTION_KEY_PREFIX}:first_seen:{device_id}"


def _cohort_key(date_text: str) -> str:
    return f"{RETENTION_KEY_PREFIX}:cohort:{date_text}"


def _active_key(date_text: str) -> str:
